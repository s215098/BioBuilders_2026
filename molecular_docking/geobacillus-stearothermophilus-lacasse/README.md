...
1. Run the docking script: "python3 blind_docking_6T0Y_BADGE.py" for blind docking or "python3 docking_6T0Y_BADGE.py" if you wish to perform targeted docking
