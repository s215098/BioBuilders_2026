def get_values(*names):
            import json
            _all_values = json.loads("""{"_pip_model":"p300_single_gen2","_pip_mount":"right","_dp_type":"nest_96_wellplate_100ul_pcr_full_skirt","_dye_type":"nest_12_reservoir_15ml","protocol_filename":"Opentrons_Logo"}""")
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    dye_vol = 100 if tip_size == "1000" else 100
